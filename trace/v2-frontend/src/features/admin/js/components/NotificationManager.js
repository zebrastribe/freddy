export class NotificationManager {
    ...
    async loadDeviceTokens() {
        ...
        notificationsContent.innerHTML = `<div id="notificationsLoading" class="flex justify-center items-center py-8"><span class="text-gray-500">Loading device tokens...</span></div>`;
        ...
        try {
            ...
            notificationsContent.innerHTML = `
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white rounded-lg shadow">
                        <thead>
                            <tr>
                                <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Device</th>
                                <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">User</th>
                                <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Token</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            notificationsContent.innerHTML = `<div class="text-red-600">Failed to load device tokens: ${error.message}</div>`;
    ...
    getPetName(petId) {
        // This would get the pet name from the pets list
        return 'Pet';
    }
    ...
    async testGlobalNotification() {
        try {
            ...
            if ('Notification' in window && Notification.permission === 'granted') {
                new Notification('Trace Admin Test', {
