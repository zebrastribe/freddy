        ...
        this.waitForGoogleMaps(() => {
          try {
            ...
            if (mapDiv) {
              ...
              this.map = null;
              console.warn('MapManager: #map container not found, skipping main map initialization.');
            }

            // Initialize the recorded check-ins map
            const recordedMapDiv = document.getElementById('recordedMap');
            if (recordedMapDiv) {
              this.recordedMap = new google.maps.Map(recordedMapDiv, {
                center: mapConfig.defaultCenter,
                zoom: mapConfig.defaultZoom,
                mapId: mapConfig.mapId,
                disableDefaultUI: true,
              ...
              this.recordedMap = null;
              console.warn('MapManager: #recordedMap container not found, skipping recorded map initialization.');
            }
